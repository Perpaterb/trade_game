...
ActiveRecord::Schema.define(version: 2021_03_11_114623) do
  ...
  create_table "start_cart_items", force: :cascade do |t|
    t.integer "owner_users_id", null: false
    t.string "stock_code", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "signinstep", default: 1, null: false
    t.string "startingstock1"
    t.string "startingstock2"
    t.string "startingstock3"
    t.string "startingstock4"
    t.string "username", null: false
